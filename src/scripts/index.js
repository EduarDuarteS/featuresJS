...
//-------------------------------------------------------//
//  Herencia -> Ejemplo hackerRank https://www.hackerrank.com/challenges/js10-inheritance/problem
//-------------------------------------------------------//
class Rectangle {
    constructor(w, h) {
        this.w = w;
...
if (JSON.stringify(Object.getOwnPropertyNames(Square.prototype)) === JSON.stringify([ 'constructor' ])) {
    ...
    console.log("propiedades con Object.getOwnPropertyNames(Square.prototype): \n",Object.getOwnPropertyNames(Square.prototype));
